...
<div class="midde_cont">
    <div class="container-fluid">
        ...
        <div class="container py-4">
            ...
            <form action="{{ route('AddToFeaturesSection') }}" method="Post" enctype="multipart/form-data" class="mt-4">
                @csrf
                @method('POST')
                ...
                <div class="row g-3">
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="text" name="feature_list_fourth" class="form-control" value="{{ old('feature_list_fourth', $feature->feature_list_fourth ?? '') }}">
                    </div>
                </div>
                ...
                <button type="submit" class="btn btn-primary mt-3">Save Feature Section</button>
